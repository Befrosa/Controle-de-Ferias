...
import styles from './MapaDeFerias.module.scss';
import { IMapaDeFeriasProps } from './IMapaDeFeriasProps';
...
const MapaDeFerias: React.FunctionComponent<IMapaDeFeriasProps> = (props) => {
  ...
  const findVacationConflicts = (): VacationConflict[] => {
  ...
  useEffect(() => {
    const loadVacations = async () => {
      ...
      try {
        ...
        const members: TeamMember[] = vacations.map(vacation => ({
          name: vacation.Title,
